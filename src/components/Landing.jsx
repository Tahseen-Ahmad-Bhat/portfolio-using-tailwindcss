      ...
      <div className="md:order-2 flex justify-center basis-3/5 z-10 mt-16 md:mt-32">
        {isAboveMediumScreens ? (
          <div className="relative w-[300px] z-0 ml-20 before:absolute before:-top-8 before:-left-16 before:rounded-t-[400px] before:w-full before:max-w-[400px] before:h-full  before:border-2 before:border-blue before:z-[-1]">
            <img
              className="h-[400px] rounded-t-[400px] saturate-150 hover:filter hover:saturate-200 transition duration-500 z-10 w-full max-w-[400px] md:max-w-[600px]"
              src="../assets/tahseenPro4.jpg"
              alt="profile"
            />
          </div>
        ) : (
      ...
      <div className="z-30 basis-2/5 mt-12 md:mt-32">
        ...
        >
          <p className="text-5xl z-10 text-center md:text-start">
            Tahseen{" "}
            <span className=" text-4xl xs:relative xs:text-deep-blue xs:font-semibold z-20 xs:before:h-[70px] before:w-[210px] before:bg-gradient-rainbow before:rounded-tr-md before:rounded-bl-lg before:absolute before:-left-[5px] before:-top-[10px] before:z-[-1]">
              Ahmad Bhat
            </span>
          </p>
          <p className="mt-10 mb-7 text-lg text-center md:text-start">
            I am a computer science student and a passionate web developer,
            always open to take new challenges and learn from them.
          </p>
        </motion.div>
